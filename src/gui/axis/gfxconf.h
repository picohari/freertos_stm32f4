...
#define GDISP_LINEBUF_SIZE                         0        /* Don't allocate a linebuf, we have real hardware streaming support */
#define GDISP_NEED_VALIDATION                      TRUE
#define GDISP_NEED_CLIP                            TRUE
#define GDISP_NEED_CIRCLE                          TRUE
#define GDISP_NEED_CONVEX_POLYGON                  TRUE
#define GDISP_NEED_ARC                             FALSE    /* must activate -lm in linker for math support */
...
#define GDISP_NEED_IMAGE                           TRUE
    ...
    #define GDISP_NEED_IMAGE_PNG                   FALSE    /* save memory !! */
