 ...
 *
 * Original image file: C:/bin/ugfx_studio_0.15_windows/ugfx_library/demos/applications/combo/rsc/chibios.gif
 */

static const char chibios[] = {
	...
	static const ROMFS_DIRENTRY chibios_dir = { 0, 0, ROMFS_DIRENTRY_HEAD, "rsc/chibios.gif", 4840, chibios };
	#undef ROMFS_DIRENTRY_HEAD
	#define ROMFS_DIRENTRY_HEAD &chibios_dir
#endif
